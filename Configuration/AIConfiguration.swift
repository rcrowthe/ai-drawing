...
struct AIConfiguration: Codable {
    ...
    var continuousDrawDuration: Double = 5.0    // How long AI continues drawing after user stops (seconds)
    var continuousDrawInterval: Double = 2.0    // Time between continuous AI strokes (seconds) - slower for better performance
    var continuousDrawMaxStrokes: Int = 10      // Maximum number of strokes in continuous mode (safety limit)
